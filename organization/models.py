...
class OrganizationDetail(models.Model):
    ...
    organization            = models.OneToOneField(Organization, on_delete = models.CASCADE, related_name ='detail')
    ...
    def __str__(self):
        return f'{self.organization.name} : {self.organization_size}'
...
class OrganizationProfile(models.Model):
    ...
    def __str__(self):
        return f'{self.organization.name} : {self.tagline}'
...
class OrganizationStaff(models.Model):
    organization         = models.OneToOneField(Organization, on_delete = models.CASCADE, related_name ='staff')
    ...
    def __str__(self):
        return f'{self.organization.name} : {self.page_superadmin.first_name} {self.page_superadmin.last_name}'
...
class OrganizationAnalytic(models.Model):
    organization         = models.OneToOneField(Organization, on_delete = models.CASCADE, related_name ='viewed_by')
